...
class OpenShiftforBranch(Document):
    ...
    def setup_shift_permissions(self):
        ...
        add_user_permission("Teller Treasury", self.teller_treasury, user)
    ...
    def remove_shift_permissions(self):
        ...
        # Remove treasury permission
        remove_user_permission("Teller Treasury", self.teller_treasury, user)
        
        # Remove permissions for accounts linked to this treasury
        accounts = frappe.get_all("Account", 
            filters={
                "custom_teller_treasury": self.teller_treasury,
                "account_type": ["in", ["Bank", "Cash"]]
        ...
        for account in accounts:
            remove_user_permission("Account", account, user)
